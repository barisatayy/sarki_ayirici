# 🎚️ Lokal Şarkı ve Enstrüman Ayrıştırma Stüdyosu
...
- **Otomatik Model Seçimi**: Seçtiğiniz ayrıştırma hedefine göre en uygun Meta AI Demucs v4 modelini (`htdemucs_ft` veya `htdemucs_6s`) otomatik olarak belirler:
  - 🎙️ **Vokal & Altyapı (2 Kanal)**: Şarkıyı Vokal (Acapella) ve temiz Altyapı olarak ayırır.
  ...
  - 🎛️ **Tüm Temel Enstrümanlar & Vokal (4 Kanal)**: Vokal, Davul, Bas, Diğer.
